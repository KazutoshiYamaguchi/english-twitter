...
<div class="card my-card-body p-3">
    <form class="form-group" action='{{route('store')}}' method="post">
        @csrf
        <textarea class="form-control mb-3" name='content' placeholder="Share your great experience" rows="3"></textarea>
        @error('content')
        ...
        @endforeach
        <p><button type="submit" class="btn btn-primary">tweet</button></p>
    </form>
</div>
@endsection
